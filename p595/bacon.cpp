...
// TODO: fill the graph G such that one vertex exists for each
...
// this as follows:
      ...
      for (int i = 0; i < size; ++i) {
        ...
        // do the work
        for(int j = 0; j  < movies[i].actors.size(); j++){
           Vertex* v = new Vertex(movies[i].actors[j]);
           cout << v->data() << endl;
...
void play(const string& filename) {
  // TODO: implement the Six Degrees of Kevin Bacon game here.
